...
const HAModuleList = lazy(() =>
	import("../../views/pages/assistant/HomeAssignment/HAModuleList")
);
const HAQuestionList = lazy(() =>
	import("../../views/pages/assistant/HomeAssignment/HAQuestionList")
);
const HAQuestion = lazy(() =>
	import("../../views/pages/assistant/HomeAssignment/HAQuestion")
);
const PRTModuleList = lazy(() =>
	import("../../views/pages/assistant/PreTest/PRTModuleList")
);
const PRTQuestionList = lazy(() =>
	import("../../views/pages/assistant/PreTest/PRTQuestionList.js")
);
const PRTQuestion = lazy(() =>
	import("../../views/pages/assistant/PreTest/PRTQuestion")
);
const Journal = lazy(() =>
	import("../../views/pages/assistant/Jurnal/JournalModuleList")
);
const SelectGroup = lazy(() =>
	import("../../views/pages/assistant/InputScore/SelectGroup")
);
const InputScore = lazy(() =>
	import("../../views/pages/assistant/InputScore/InputScore")
);
const BAP = lazy(() => import("../../views/pages/assistant/BAP/BAP"));
const HasilInput = lazy(() =>
	import("../../views/pages/assistant/HasilInput/HasilInput")
);
const ViewNilai = lazy(() =>
	import("../../views/pages/assistant/HasilInput/ViewNilai")
);
const UpdateScore = lazy(() =>
	import("../../views/pages/assistant/HasilInput/UpdateScore")
);
const StudentList = lazy(() =>
	import("../../views/pages/assistant/user/StudentList")
);
