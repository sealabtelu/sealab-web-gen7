...
import { Home, Clipboard, Bookmark, Edit3, PenTool, Book, AlertTriangle, User, Circle, BookOpen, Paperclip, Star, FileText, Code, Feather } from "react-feather";
...
const FTModuleList = lazy(() => import("../../views/pages/assistant/FinalTest/FTModuleList"));
...
const AssistantRoutes = [
  ...
  {
    path: "/assistant/final-test/master-control",
    element: <FTModuleList />,
  },
  {
    ...
    children: [
      {
        ...
        title: "Master Control",
        icon: <Circle />,
        navLink: "/assistant/final-test/master-control",
      },
    ],
  },
  {
