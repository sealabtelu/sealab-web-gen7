...
const HAQuestionList = lazy(() =>
	import("../../views/pages/student/HomeAssignment/HAQuestionList")
);
const PRTQuestionList = lazy(() =>
	import("../../views/pages/student/PreTest/PRTQuestionList")
);
const HomeAssigment = lazy(() =>
	import("../../views/pages/student/HomeAssignment/HomeAssignment")
);
...
const Profile = lazy(() =>
	import("../../views/pages/student/Profile/AccountTabContent")
);
