    ...
    return (
        <>
            ...
            <div className="header-wrapper">
                {/* iSmile Logo */}
                <a href="#" >
                    <img src="src\assets\images\landing\Vertical.jpg" className="ismile-logo" alt="iSmile Logo"/>
                </a>
            ...
            <div className="main-wrapper">
                ...
                <div className="image-content">
                    <img src="src\assets\images\landing\ismile-card-landingpage.png" alt="" />
                </div>
            </div>
            ...
            <div className="about" id="about-lab">
                ...
                <div className="img-wrapper">
                    <img src="src\assets\images\landing\template-frame.png" alt=""/>
                </div>
                {/* INFO */}
                <div className="info-wrapper">
                    <div className="info-content">
                        <h1>About Us</h1>
                        <p>i-Smile (Intelligent System and Machine Learning) Laboratory merupakan bagian dari Laboratorium RAID (Realm of Artificial Intelligence Design) yang berfokus pada pengembangan Kecerdasan Buatan (Artificial Intelligence).</p>
                    </div>
                    <img src="src\assets\images\landing\eyes_3d.png" alt=""/>
                </div>
