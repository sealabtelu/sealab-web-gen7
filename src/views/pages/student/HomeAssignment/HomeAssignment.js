  ...
  return (
    <div>
      <Card className="card-overlay-jurnal">
        ...
        <ol type="1">
          <li>
            Pastikan kalian sudah menonton video praktikum di Youtube channel{" "}
            <a target="_blank" href="https://www.youtube.com/@SEALaboratory">
              SEA Laboratory
            </a>
          </li>
          <li>
          ...
          <li>
            Tugas Pendahuluan dikerjakan menggunakan Template Tugas Pendahuluan yang dapat di akses{" "}
            <a target="_blank" href="https://telkomuniversityofficial-my.sharepoint.com/:w:/g/personal/yogasherlambang_student_telkomuniversity_ac_id/EbhL8XLdtQNFsF2myz1wM-UBwpKOxhaeIsYMsULGEf-pgQ?e=amCIzq">
              di sini
            </a>
            .
          </li>
          ...
          <li>
            <b>Keterlambatan</b> dalam mengumpulkan Tugas Pendahuluan akan mengakibatkan <b>pengurangan nilai</b> pada Tugas Pendahuluan di modul yang bersangkutan.
          </li>
        </ol>
      </Card>
      {isLoading ? (
        ...
        modules.map((item, index) => (
          <div key={item.id}>
            {isOpenClicked === item.id && <OverlayHA moduleTitle={item.name} moduleNumber={index + 1} item={item} />}
              ...
              <Card className="card-student">
                <CardHeader>
                  ...
                  {item.isOpen && !item.isSubmitted ? (
                    <Button color="relief-primary" onClick={() => handleOpenClick(item.id)}>
                      Open
                    </Button>
                  ) : (
